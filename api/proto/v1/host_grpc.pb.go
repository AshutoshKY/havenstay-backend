...
const (
	HostService_GetHost_FullMethodName    = "/host.v1.HostService/GetHost"
	HostService_CreateHost_FullMethodName = "/host.v1.HostService/CreateHost"
)
...
type HostServiceClient interface {
	GetHost(ctx context.Context, in *GetHostRequest, opts ...grpc.CallOption) (*HostResponse, error)
	CreateHost(ctx context.Context, in *CreateHostRequest, opts ...grpc.CallOption) (*HostResponse, error)
}
...
func (c *hostServiceClient) GetHost(ctx context.Context, in *GetHostRequest, opts ...grpc.CallOption) (*HostResponse, error) {
...
func (c *hostServiceClient) CreateHost(ctx context.Context, in *CreateHostRequest, opts ...grpc.CallOption) (*HostResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HostResponse)
...
type HostServiceServer interface {
	GetHost(context.Context, *GetHostRequest) (*HostResponse, error)
	CreateHost(context.Context, *CreateHostRequest) (*HostResponse, error)
...
func (UnimplementedHostServiceServer) GetHost(context.Context, *GetHostRequest) (*HostResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetHost not implemented")
}
func (UnimplementedHostServiceServer) CreateHost(context.Context, *CreateHostRequest) (*HostResponse, error) {
...
var HostService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "host.v1.HostService",
	...
	Metadata: "api/proto/v1/host.proto",
}
